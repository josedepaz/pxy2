...
define('pxy2/tests/routes/manager.jshint', ['exports'], function (exports) {
  'use strict';
...
define('pxy2/tests/unit/routes/manager-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/routes/manager-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/manager-test.js should pass jshint.');
  });
});
/* jshint ignore:start */
